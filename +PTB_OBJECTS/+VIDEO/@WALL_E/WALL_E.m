classdef WALL_E < PTB_OBJECTS.VIDEO.Base
    ...
    properties
        ...
        imgFree       (1,1) PTB_OBJECTS.VIDEO.Image
        imgArrowRight (1,1) PTB_OBJECTS.VIDEO.Image
        imgArrowLeft  (1,1) PTB_OBJECTS.VIDEO.Image
        imgArrowUp    (1,1) PTB_OBJECTS.VIDEO.Image
        imgArrowDown  (1,1) PTB_OBJECTS.VIDEO.Image
